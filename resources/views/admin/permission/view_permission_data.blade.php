...
@section('content')
                    ...
                    <div class="float-right">
                      ...
                      <form>
                        <div class="input-group">
                          ...
                          @if(!trim(request('q')) == '')
                      		&nbsp;&nbsp;<a href="{{ route('list_permission_admin') }}"><u>reset</u></a>
                      	  @endif
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="table-responsive" style="min-height: 50vh;">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <td>{{ $data->sip_ref_permissions_name }}</td>
                          <td>
                            {{ $data->sip_ref_permissions_code }}
                          </td>
                          <td>                          	
                          	{{ $data->created_at }}
                          </td>
                          <td>
              							...
              							<div class="dropdown">
              							  <button class="btn btn-sm btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton{{ $data->sip_ref_permissions_id }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              							    Options
              							  </button>
              							  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $data->sip_ref_permissions_id }}">
              							    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit-{{ $data->sip_ref_permissions_id }}">Edit</a>
              							    <div class="dropdown-divider"></div>
              							    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete-{{ $data->sip_ref_permissions_id }}">Hapus</a>
              							  </div>
              							</div>
		...
		<div class="modal fade" id="new" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
		    ...
		    <form method="post" action="{{ route('add_permission_admin') }}">
...
@section('footer')
	@if(session()->has('type') && session()->get('type') == 'addPermission')
