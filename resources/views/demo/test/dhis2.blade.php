...
@section('content')
  ...
  <div class="panel panel-default">
    <div class="panel-body">
      <h3>Output</h3>
      <div class="table-responsive" id="output-table-here">
...
@section('scripts')
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      //get value
      $.get("{{ URL::to('api/activities/1/forms/2/values') }}", function(data, status){
          
      });

      //get params
      $.get("{{ URL::to('api/activities/1/forms/2/params') }}", function(data, status){
          
          var html = ''; 
          var input = '<form method="post" id="post-data" action="{{ URL::to('api/activities/1/forms') }}"';
          ...
          for(var i=0; i < data.length;i++){
            ...
            for(var a=0; a < data[i].tables.length;a++){
              ...
              input+='<table class="table form-tableble-striped">';
